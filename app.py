...
from .database import getRegisteredAttendees
# TODO: replace this database here and use the supabase one with formatted information.
app = Flask(__name__)
...
def attendance():
    ...
    attendance_data = getRegisteredAttendees(formatted_date)
